...
document.getElementById("right-button").addEventListener("click", function () {
    simulateKeyPress(68); // Simulate the 'D' key press (right)
});

document.getElementById("down-button").addEventListener("click", function () {
    simulateKeyPress(83); // Simulate the 'S' key press (down)
});

document.getElementById("rotate-button").addEventListener("click", function () {
    simulateKeyPress(69); // Simulate the 'E' key press (rotate)
});
});
...
function DrawTetrisLogo(){
    ctx.drawImage(tetrisLogo, 320, 350, 100, 100);
}
